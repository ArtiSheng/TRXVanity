    ...
    internal static class BackupDecryptProgram
    {
        private static int Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("警告：该 JSON 包含明文助记词，请妥善保管。");
                return 0;
            }
        ...
        private static int SelfTest()
        {
            ...
            if (clear.IndexOf("TUEZSdKsoDHQMeZwihtdoBiN46zxhGWYdH", StringComparison.Ordinal) < 0
                || clear.IndexOf("abandon abandon abandon", StringComparison.Ordinal) < 0
                || clear.IndexOf("m/44'/195'/0'/0/0", StringComparison.Ordinal) < 0)
            {
